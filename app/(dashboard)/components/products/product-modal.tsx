        ...
        <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? "Edit Product" : "Add New Product"}>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="input-group-admin">
                    ...
                    <textarea name="description" id="description" rows={7} placeholder="Products Details ..." value={formData.description} onChange={handleChange}>
                        
                    </textarea>
                </div>
                <Button className="ml-auto mt-2 rounded-lg" onClick={handleSubmit} disabled={isSubmitting} type="submit">
