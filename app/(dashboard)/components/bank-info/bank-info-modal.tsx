            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div className="flex flex-col gap-4 w-full">
                        <div className="input-group-admin">
                            ...
                            <input type="text" id="bankName" name="bankName" placeholder="(e. g. ABC)" value={formData.bankName} onChange={handleChange}/>
                        </div>  
                        <div className="input-group-admin">
                            <label htmlFor="accountNumber">Account Number</label>
                            <input type="text" id="accountNumber" name="accountNumber" placeholder="(e. g. 151464131314)" value={formData.accountNumber} onChange={handleChange}/>
                        </div>  
                        <div className="input-group-admin">
                ...
                <Button className="ml-auto mt-2 rounded-lg" type="submit" onClick={handleSubmit} disabled={isSubmitting}>
