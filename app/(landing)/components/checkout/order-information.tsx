    ...
    <CardWithHeader title="Order Information">
        <div className="p-5">
            ...
            <div className="input-group">
                ...
                <textarea placeholder="Type your shipping address" id="customerAddress" name="customerAddress" rows={6} value={formData.customerAddress} onChange={handleInputChange} />
            </div>
        </div>
    </CardWithHeader>
  )
